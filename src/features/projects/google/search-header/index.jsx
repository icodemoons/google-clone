...
export default function SearchHeader({ query, setQuery }) {
  return (
    <header className="sticky top-0 mx-auto w-full items-center justify-between p-6 px-3 sm:pl-[5] md:pl-[14%] lg:pl-52">
      <div>
        <div className="mt-4 flex w-full max-w-2xl items-center rounded-full border border-gray-700 bg-white px-6 py-3 pl-8 text-xl   shadow-gray-700 focus-within:shadow-lg hover:shadow-xl  sm:max-w-xl lg:max-w-xl">
          <input
            value={query}
